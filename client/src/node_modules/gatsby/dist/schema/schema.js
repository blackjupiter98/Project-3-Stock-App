...
const buildSchema = async ({
  ...
  const schema = schemaComposer.buildSchema(); // Freeze all type composers except SitePage (as we will rebuild it at a later stage)

  freezeTypeComposers(schemaComposer, new Set([`SitePage`])); // console.log(printSchema(schema))
